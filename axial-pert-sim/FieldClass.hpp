...
public:
    ...
    void initialiseGaussian(double mean, double sigma, double a, double v);

    // initialises array with d/dx gaussian(x)
    void initialiseDGaussianDX(double mean, double sigma, double a, double v);
    ...
    // 4th order 2nd derivative, left lopsided
    inline double d2_4th_left(int i);

    // 4th order 2nd derivative, right lopsided
    inline double d2_4th_right(int i);

    // 4th order 1st derivative, left lopsided
    inline double d1_4th_left(int i);

    // 4th order 1st derivative, right lopsided
    inline double d1_4th_right(int i);
